...
export default function CustomizationForm() {
    ...
    return (
        <form
            className="mx-auto sm:w-full max-w-screen-sm shadow-lg grid grid-cols-1 gap-5 p-10 px-5 xs:px-10 pt-5 mb-20 rounded-xl xs:grid-cols-2 bg-white border border-y-[1.5rem] border-y-black"
